...
EXPRESSVPN_ROOT="${EXPRESSVPN_ROOT:-/opt/expressvpn/honeygain_expressvpn}"
...
start_instance() {
  ...
  ip netns exec "$ns" bash -lc 'exec ./app/honeygain_file/honeygain' >"$WORKDIR/app_${idx}.log" 2>&1 &
