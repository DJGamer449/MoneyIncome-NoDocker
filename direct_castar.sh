...
CASTAR_KEY="xxxxxxxxxxxxxx" 
# Full path to your Castar binary
CASTAR_PATH="./app/CastarSDK"
...
start_hev_socks5_tunnel_and_app() {
  ...
  # Start hev-socks5-tunnel in namespace
...
EOF
  ...
  echo "[$idx] Starting CastarSDK via proxy=$proxy (netns=$ns)"
