...
-   Run instances with isolated per-namespace ExpressVPN IPs
-   Each service runs in its own isolated netns
-   Automatic ExpressVPN routing per network namespace
...
install_hev-socks5-tunnel.sh (now ExpressVPN helper)\
proxies.txt
...
- `6` to verify ExpressVPN CLI setup
...
-   Routes traffic through ExpressVPN in each namespace
