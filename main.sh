...
run_earnapp() {
  ...
  sudo BASE_NS=earnns VETH_PREFIX=earn WORKDIR=/tmp/earnapp_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" \
    bash "$EARNAPP_SCRIPT" &
  PIDS+=($!)
}
...
run_traff() {
  ...
  echo "Starting Traff..."
  sudo BASE_NS=traffns VETH_PREFIX=traff WORKDIR=/tmp/traff_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" EXPRESSVPN_HELPER="$BASE_DIR/direct_expressvpn_common.sh" \
    bash "$RUNTIME" &
  PIDS+=($!)
}
...
run_packetstream() {
  ...
  sudo BASE_NS=psns VETH_PREFIX=ps WORKDIR=/tmp/ps_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" EXPRESSVPN_HELPER="$BASE_DIR/direct_expressvpn_common.sh" \
    bash "$RUNTIME" &
  PIDS+=($!)
}
...
run_castar() {
  ...
  sudo BASE_NS=castarns VETH_PREFIX=castar WORKDIR=/tmp/castar_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" EXPRESSVPN_HELPER="$BASE_DIR/direct_expressvpn_common.sh" \
    bash "$RUNTIME" &
  PIDS+=($!)
}
...
run_urnetwork() {
  ...
  sudo BASE_NS=urns VETH_PREFIX=ur WORKDIR=/tmp/ur_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" \
    bash "$UR_SCRIPT" &
  PIDS+=($!)
}
...
run_wipter() {
  ...
  sudo BASE_NS=wipterns VETH_PREFIX=wipter WORKDIR=/tmp/wipter_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" WIPTER_EMAIL="$WIPTER_EMAIL" WIPTER_PASSWORD="$WIPTER_PASSWORD" \
    bash "$WIPTER_SCRIPT" &
  PIDS+=($!)
}
...
run_honeygain() {
  ...
  sudo BASE_NS=honeyns VETH_PREFIX=honey WORKDIR=/tmp/honeygain_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" HONEYGAIN_ACCOUNTS="$account_blob" \
