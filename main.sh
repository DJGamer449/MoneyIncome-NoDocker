...
run_traff() {
  ...
  echo "Starting Traff..."
  sudo BASE_NS=traffns VETH_PREFIX=traff WORKDIR=/tmp/traff_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" \
    bash "$RUNTIME" &
  PIDS+=($!)
}
...
run_packetstream() {
  ...
  sudo BASE_NS=psns VETH_PREFIX=ps WORKDIR=/tmp/ps_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" \
    bash "$RUNTIME" &
  PIDS+=($!)
}
...
run_castar() {
  ...
  sudo BASE_NS=castarns VETH_PREFIX=castar WORKDIR=/tmp/castar_multi INSTANCE_COUNT="$VPN_INSTANCE_COUNT" EXPRESSVPN_ACTIVATION_CODE="$EXPRESSVPN_ACTIVATION_CODE" EXPRESSVPN_PROTOCOL="$EXPRESSVPN_PROTOCOL" \
    bash "$RUNTIME" &
  PIDS+=($!)
}
